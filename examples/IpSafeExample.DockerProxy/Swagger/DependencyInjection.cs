...
namespace IpSafeExample.DockerProxy.Swagger
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddSwagger(this IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "IpSafe Docker Proxy API", Version = "v1" });
        ...
        public static IApplicationBuilder UseSwagger(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "IpSafe Docker Proxy API v1");
